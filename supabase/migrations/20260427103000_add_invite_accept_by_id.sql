create or replace function public.accept_pitcher_profile_invite_internal(
  p_invite_id uuid,
  p_user_id uuid,
...
begin
  ...
  return public.accept_pitcher_profile_invite_internal(
    v_invite_id,
    p_user_id,
    p_normalized_email
  );
...
create or replace function public.accept_pitcher_profile_invite_for_user_by_id(
  p_invite_id uuid,
  p_user_id uuid,
  p_normalized_email text
)
...
revoke all on function public.accept_pitcher_profile_invite_internal(uuid, uuid, text)
...
revoke all on function public.accept_pitcher_profile_invite_for_user_by_id(uuid, uuid, text)
from public, anon, authenticated;

grant execute on function public.accept_pitcher_profile_invite_for_user_by_id(uuid, uuid, text)
to service_role;
